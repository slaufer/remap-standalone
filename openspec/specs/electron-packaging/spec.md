...
Defines requirements for building and distributing Remap as a cross-platform desktop application using Electron and electron-builder, producing platform-native installers from the existing Vite web build.
